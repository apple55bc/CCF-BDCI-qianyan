...
import numpy as np
from bert4keras_7_5.layers import *
from bert4keras_7_5.snippets import delete_arguments
...
class Transformer(object):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.name = name
        self.built = False
        if 'type_vocab_size' in kwargs.keys():
            self.type_vocab_size = kwargs['type_vocab_size']
        else:
