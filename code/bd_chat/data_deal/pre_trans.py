...
from bd_chat.data_deal.base_input import *


def trans(data_type):
    data_dict = {
        0: join(DATA_PATH, 'DuRecDial/train.txt'),
        1: join(DATA_PATH, 'DuRecDial/dev.txt'),
        2: join(DATA_PATH, 'DuRecDial/test.txt'),
        3: join(DATA_PATH, 'DuRecDial/test_2.txt'),
    }
